...
class LogbookConfig(AppConfig):
    ...
    def _setup_default_clinical_data(self):
        ...
        try:
            ...
            if (Procedure.objects.exists() or 
                Diagnosis.objects.exists() or 
                Skill.objects.exists()):
                return
            ...
            default_skills = [
                ...
                ('Patient Communication', 'communication', 'basic', 'Effective patient communication'),
                
                # Intermediate Skills
                ('Differential Diagnosis', 'clinical', 'intermediate', 'Clinical reasoning and diagnosis'),
                ('Treatment Planning', 'clinical', 'intermediate', 'Therapeutic decision making'),
                ('Multidisciplinary Collaboration', 'communication', 'intermediate', 'Team-based care'),
                ...
                # Professional Skills
                ('Ethical Decision Making', 'professional', 'intermediate', 'Medical ethics application'),
                ('Quality Improvement', 'professional', 'intermediate', 'Healthcare quality initiatives'),
            ...
            import logging
            logger = logging.getLogger('sims.logbook')
            logger.info("Default clinical data (procedures, diagnoses, skills) created successfully")
