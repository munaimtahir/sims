...
urlpatterns = [
    ...
    path('<int:certificate_pk>/review/', 
         views.CertificateReviewCreateView.as_view(), 
         name='review'),
    path('review/<int:pk>/', 
         views.CertificateReviewDetailView.as_view(), 
         name='review_detail'),
    
    # Certificate management views
    path('bulk-approval/', 
         views.BulkCertificateApprovalView.as_view(), 
         name='bulk_approval'),
    path('compliance/', 
         views.CertificateComplianceView.as_view(), 
         name='compliance'),
