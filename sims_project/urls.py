...
urlpatterns = [
    ...
    # API URLs (for AJAX and mobile app integration)
    path('api/v1/', include([
        ...
        path('workshops/', include('sims.workshops.api_urls')),
        path('logbook/', include('sims.logbook.api_urls')),
        path('cases/', include('sims.cases.api_urls')),
        path('analytics/', include('sims.analytics.api_urls')),
        path('notifications/', include('sims.notifications.api_urls')),
    ])),
...
urlpatterns += [
    ...
    path('upload/workshop/', lambda request: redirect('workshops:upload'), name='quick_upload_workshop'),
