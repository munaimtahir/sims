# SIMS Deployment Instructions for VPS (139.162.9.224:81)

## Overview
This guide provides step-by-step instructions to deploy the SIMS application on your VPS at `139.162.9.224` on port `81`.

## Prerequisites
- SSH access to the VPS server (139.162.9.224)
